...
?>
    ...
    <!-- Hero Start -->
    <div class="container-fluid bg-primary py-5 mb-5 hero-header" style="background-image: url(<?php echo get_field("banner_background_image", $page_id); ?>);">
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5"
                        style="border-color: rgba(256, 256, 256, .3) !important;"><?php echo get_field("heading_short_upper_text", $page_id); ?></h5>
                    <h1 class="display-1 text-white mb-md-4"><?php echo get_field("heading_title", $page_id); ?></h1>
                    <div class="pt-2">
                        <a href="<?php echo get_field("first_banner_button", $page_id)['url']; ?>" class="btn btn-light rounded-pill py-md-3 px-md-5 mx-2"><?php echo get_field("first_banner_button", $page_id)['title']; ?></a>
                        <a href="<?php echo get_field("second_banner_button", $page_id)['url']; ?>" class="btn btn-outline-light rounded-pill py-md-3 px-md-5 mx-2"><?php echo get_field("second_banner_button", $page_id)['title']; ?></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row gx-5">
                ...
                <div class="col-lg-7">
                    ...
                    <p><?php echo get_field("short_description", $page_id); ?></p>
